...
public class ComponentResizer extends MouseAdapter
{
	...
	public void mousePressed(MouseEvent e)
	{
        ...
        private OnMouseReleasedListener mouseReleasedListener;
        public interface OnMouseReleasedListener {
            void onMouseReleased();
        }

        public void setMouseReleasedListener(OnMouseReleasedListener mouseReleasedListener) {
		...
		if (source instanceof JComponent)
		{
			((JComponent)source).setAutoscrolls( autoscrolls );
                ...
                if (mouseReleasedListener != null)
                    mouseReleasedListener.onMouseReleased();
	}
