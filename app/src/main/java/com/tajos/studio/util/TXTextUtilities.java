...
public class TXTextUtilities
{
	...
	/**
	 *  Return the column number at the Caret position.The column returned will only make sense when using a
            Monospaced font.
	 *
         * @param component
         * @return 
	...
	public static void gotoStartOfLine(JTextComponent component, int line)
	{
        ...
        public static int getLineStartOffset(JTextComponent comp, int line)
        {
        ...
        public static int getLineLastOffset(JTextComponent comp, int line)
        {
            Element root = comp.getDocument().getDefaultRootElement();
            line = Math.max(line, 1);
            line = Math.min(line, root.getElementCount());
        ...
        public static Rectangle2D getTextRect(JTextComponent comp, String tx)
        {
            return comp.getFontMetrics(comp.getFont()).getStringBounds(tx, comp.getGraphics());
        }
